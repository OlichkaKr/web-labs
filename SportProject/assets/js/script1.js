...
class Fan {
    ...
    constructor() {
        try {
            ...
            var title = document.getElementById("fantitle").value;
        } catch (e) {
            var message = "";
            var title = "";
        }
    ...
    append() {
        var original = document.getElementById("feedbacks");
        var fan = document.createElement("div");
        var classElem = original.childNodes[1].getAttribute("class");
        ...
        fan.innerHTML =
            '<div class="feedbacks-' + classTheme + ' col-md-12"><p>' + `${(this.fantext)}` + '</p>'
            +'<div class="info">'
            +'<div class="author-' + classTheme + '">' + `${(this.date)}` + '</div>'
            +'<div class="author-' + classTheme + '">' + `${(this.fantitle)}` + '</div>'
            +'</div>'
            +'</div>'
        ...
        original.insertBefore(fan, original.childNodes[1]);
        document.getElementById("message").value = "";
        document.getElementById("fantitle").value = "";
    }
    check() {
